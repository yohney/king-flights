...
namespace King.FlightSearch.Web
{
    ...
    public class ApplicationUserManager : UserManager<User>
    {
        ...
        public ClaimsIdentity GenerateUserIdentity(User user)
        {
        ...
        {
            return Task.FromResult(this.GenerateUserIdentity(user));
        }

        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            var manager = new ApplicationUserManager(new UserStore<User>(context.Get<FlightDbContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<User, string>
    {
        ...
        {
            return this.AppUserManager.GenerateUserIdentityAsync(user);
        }
